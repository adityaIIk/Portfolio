...
import lit from "../Edu/lit.png";


type Props = {};

export default function Educard1({}: Props) {
  return (
    <article
    ...
    >
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <Image className="w-24 h-24 object-scale-down " src={lit} alt="" />
       
      </motion.div>

      <div className="text-center px-0 md:px-10 object-center">
        <h4 className="font-bold text-2xl ">Secondary Education</h4>
